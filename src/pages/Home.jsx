...
export default function Home() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-black">
        <div className="sticky top-10 z-50 bg-black px-4 pb-3 border-b border-gray-800" style={{ paddingTop: 'calc(1rem + env(safe-area-inset-top))' }}>
  ...
  return (
    ...
    <div className="min-h-screen bg-black">
      ...
      {banners.length > 0 && (
        <div className="max-w-screen-sm mx-auto py-4" style={{ backgroundColor: '#000' }}>
          {/* 캐러셀 트랙 */}
          <div
